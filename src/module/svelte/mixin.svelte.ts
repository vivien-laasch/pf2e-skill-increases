import type { AnyObject, ConstructorOf, DeepPartial, Mixin } from "@league-of-foundry-developers/foundry-vtt-types/src/types/utils.d.mts";
...
function SvelteApplicationMixin<BaseClass extends ConstructorOf<ApplicationV2<any, any, any>>>(BaseApplication: BaseClass) {
    // @ts-expect-error
    class SvelteApplication<
        ...
        out RenderOptions extends ApplicationV2.RenderOptions = BaseClassI extends ConstructorOf<ApplicationV2.Internal<any, infer _RenderOptions, any>>
            ? _RenderOptions
            : never,
        out RenderContext extends AnyObject = BaseClassI extends ConstructorOf<ApplicationV2.Internal<any, any, infer _RenderContext>> ? _RenderContext : never,
